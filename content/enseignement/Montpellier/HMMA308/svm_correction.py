...
ax = plt.gca()
plot_2d(X, y)
# wsgd = [clf_linear.intercept_[0], clf_linear.coef_[0, 0], clf_linear.coef_[0, 1]]
wsgd = [0, 0, 0]

frontiere_new(clf_linear, X, y, ax)

# frontiere_new(clf_linear.predict, X, y)
...
# wsgd = [clf_poly.intercept_[0], clf_poly.coef_[0, 0], clf_poly.coef_[0, 1]]

frontiere_new(clf_poly, X, y, ax)

# frontiere_new(clf_poly.predict, X, y)
